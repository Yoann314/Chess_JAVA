...
public class Plateau implements ActionListener {
	...
	*/
	...
	public void init() {
		pieces[0][0] = new Tour(joueur,0,0);
		pieces[0][1] = new Cavalier(joueur,0,1);
		pieces[0][2] = new Fou(joueur,0,2);
		pieces[0][3] = new Reine(joueur,0,3);
		pieces[0][4] = new Roi(joueur,0,4);
		pieces[0][5] = new Fou(joueur,0,5);
		pieces[0][6] = new Cavalier(joueur,0,6);
		pieces[0][7] = new Tour(joueur,0,7);

		for(int i = 8; i < 16; i++){
			pieces[0][i] = new Pion(joueur,1,i);
		}

		for(int i = 8; i < 16; i++){
			pieces[1][i] = new Pion(joueur,6,i);
		}

		pieces[1][0] = new Tour(joueur,7,0);
		pieces[1][1] = new Cavalier(joueur,7,1);
		pieces[1][2] = new Fou(joueur,7,2);
		pieces[1][3] = new Reine(joueur,7,3);
		pieces[1][4] = new Roi(joueur,7,4);
		pieces[1][5] = new Fou(joueur,7,5);
		pieces[1][6] = new Cavalier(joueur,7,6);
		pieces[1][7] = new Tour(joueur,7,7);
